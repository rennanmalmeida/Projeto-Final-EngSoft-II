      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
              ...
              <label htmlFor="product-minimumStock" className="text-sm font-medium">Estoque mínimo</label>
              <Input
            ...
            />
              className="h-32 resize-none"
              maxLength={500}
            <label htmlFor="product-imageUrl" className="text-sm font-medium">URL da imagem</label>
            <Input
              id="product-imageUrl"
